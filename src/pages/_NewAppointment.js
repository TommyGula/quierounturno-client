    ...
    switch(step) {
      case 0:
        return (
          ...
          <ItemsListDropdown static image={(src) => process.env.REACT_APP_BACKEND_PATH + "uploads/" + src} imageAttr="logo" items={[store]} title="Negocio seleccionado" seemoretarget={"selectedStore"} noCta readonly></ItemsListDropdown>
          ...
          />
          {
              ...
              <ItemsListDropdown static items={services.filter(service => service._id === context.appointment.service.serviceId)} seemoretarget={"selectedStoreServices"} ctaText="VER" readonly></ItemsListDropdown> : null
          }
          </div>
        )
      case 1: 
